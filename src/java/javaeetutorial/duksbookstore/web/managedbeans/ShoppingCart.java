...
public class ShoppingCart extends AbstractBean implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("javaeetutorial.duksbookstore.web.managedbeans.ShoppingCart");
    /**
    ...
    public synchronized List<ShoppingCartItem> getIntems() {
    ...
    public synchronized int getNumberOfItems() {
        ...
        numberOfItems = 0;
        for (ShoppingCartItem item : getIntems()) {
